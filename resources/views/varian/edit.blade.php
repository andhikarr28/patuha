...
<div class="max-w-5xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <a href="{{ route('barang.show', $varian->barang_id) }}"
    ...
    <form action="{{ route('varian.update', $varian) }}"
          method="POST">
            ...
            <div class="p-7 space-y-7">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number"
                                   name="harga_beli"
                                   value="{{ old('harga_beli', $varian->harga_beli) }}"
                                   min="0"
                                   class="w-full
                                          border border-slate-300
                                          rounded-xl
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number"
                                   name="harga_jual"
                                   value="{{ old('harga_jual', $varian->harga_jual) }}"
                                   min="0"
                                   required
                                   class="w-full
                                          border border-slate-300
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-2">
                            Stok tidak diedit manual. Perubahan stok dilakukan melalui transaksi penerimaan dan penjualan.
                        </p>
                    ...
                    <div>
                        ...
                        <input type="number"
                               name="stok_minimum"
                               value="{{ old('stok_minimum', $varian->stok_minimum) }}"
                               min="0"
                               required
                               class="w-full
                                      border border-slate-300
